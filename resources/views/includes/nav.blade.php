<nav class="container border-b flex items-center justify-between  border border-gray-800 m-auto">
    ...
    <div class="flex items-center">
        <div class="relative mr-5">
            ...
            <input type="text" placeholder="Seach" class="pl-10 focus:outline-none focus:shadow-outline rounded-full py-1.5 bg-gray-800 w-64" >
        </div>
